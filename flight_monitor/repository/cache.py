...
def price_key(source: str, route: dict) -> str:
    ...
    источник (browser и api дают разные цены), число пересадок (s0 = прямой,
    sN = ровно N пересадок) и число пассажиров (pN — цена за всех)."""
    stops = route.get("stops_wanted", 0)
